      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-3">
            <h3 className="text-xl font-bold text-emerald-400 tracking-tight">Bengali Food<br />Calorie Estimator</h3>
            <p className="text-gray-300 text-sm leading-relaxed">
                AI-powered nutritional analysis<br />for authentic Bengali cuisine.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/dashboard" className="text-gray-400 hover:text-emerald-400 transition-colors">Predict Calories</Link></li>
              <li><Link to="/about" className="text-gray-400 hover:text-emerald-400 transition-colors">How It Works</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mt-4">
              <p className="text-gray-400">contact@bengalicalorie.com</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 pt-6 border-t border-gray-800 text-center text-gray-500 text-sm">
          <p>© {new Date().getFullYear()} Bengali Food Calorie Estimator. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
