...
const food_map = {
  Biriyani: { calories: 350, category: "rice", meals: ["lunch", "dinner"], treat: true },
  ...
  Hilsha_Fish_Curry: { calories: 400, category: "protein", meals: ["lunch", "dinner"], treat: true },
  ...
  Cake: { calories: 290, category: "dessert", meals: ["breakfast", "snack"], treat: true },
  ...
  Fried_Rice: { calories: 333, category: "rice", meals: ["lunch", "dinner"], treat: true },
  Kacchi_Biriyani: { calories: 360, category: "rice", meals: ["lunch", "dinner"], treat: true },
  Kebab: { calories: 330, category: "protein", meals: ["lunch", "dinner"], treat: true },
  Shik_Kebab: { calories: 300, category: "protein", meals: ["lunch", "dinner"], treat: true },
  Singara: { calories: 220, category: "snack", meals: ["breakfast", "snack"], treat: true },
  Vegetable_Beguni: { calories: 180, category: "snack", meals: ["snack"], treat: true },
  Lentil_Soup: { calories: 116, category: "protein", meals: ["breakfast", "lunch", "dinner"] },
  Dal_Puri: { calories: 190, category: "carb", meals: ["breakfast", "lunch"], treat: true },
  Poached_Egg: { calories: 72, category: "protein", meals: ["breakfast"] },
  Pizza: { calories: 285, category: "carb", meals: ["lunch", "dinner"], treat: true },
  Misti: { calories: 250, category: "dessert", meals: ["snack", "dinner"], treat: true },
  ...
  Cup_Cakes: { calories: 270, category: "dessert", meals: ["snack"], treat: true },
};
